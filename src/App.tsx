  ...
  const generateHealthTip = async () => {
    try {
      ...
      const response = await openai.chat.completions.create({
        model: 'deepseek-chat',
        messages: [
          { role: 'system', content: 'Ты - ИИ-помощник ГБУЗ РТ "Дзун-Хемчикский ММЦ". Давай короткие советы по здоровью. ЗАПРЕЩЕНО использовать Markdown (звездочки **, решетки и т.д.). Только чистый текст.' },
